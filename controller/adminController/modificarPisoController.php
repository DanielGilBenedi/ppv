...
//Se mueve la imagen al servidor
    ...
    if($imagen == '/DWES_PHP_PPV_2020/images/'){

        $imagen = $_POST['imagenCambiar'];
    }
...
if($piso->modificarPisos($id,$descripcion, $titulo, $imagen, $telefonoMsg, $precio, $numHabitaciones, $distancia)) {
    header("Location: /../../DWES_PHP_PPV_2020/view/adminPanel/modificarPiso.php");
}else{
    die();
}
}else{
