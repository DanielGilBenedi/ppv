...
<style>
    ...
    <script>
        function visto(){
            alert('Mensaje marcado como visto');
    ...
    if ($result->num_rows > 0) {
        ...
        <tr>
            ...
            <th scope="col">Fecha</th>
                ...
                <tr>        
                    <form method="post" action="../../controller/adminController/deleteMensajeController.php">
                    ...
                    <th>
                       ...
                       <form method="post" action="../../controller/adminController/mensajeVisto.php">
                       <input type="hidden" name="id" value=" ' .   ($row['id']) . '">
                        <button onsubmit="visto()" type="submit" class="btn btn-secondary"><i class="fas fa-eye"></i></button>
                        </form>
